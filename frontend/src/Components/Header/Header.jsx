        ...
        {isAuthenticated ? (
          <li className="dropdown">
            ...
            <div className="admin-dropdown-menu">
              ...
              <Link to="/admin/whatsapp-contacts">Contact Logs</Link>
              <Link to="/admin/track-orders">Track Orders</Link>
              <Link to="/admin/making-videos">Making Video</Link>
              <Link to="/admin/media">Media</Link>
              <button className="logout-btn" onClick={handleLogout} style={{ marginTop: '10px', borderTop: '1px solid rgba(196, 149, 58, 0.15)', paddingTop: '10px' }}>Logout</button>
            </div>
          </li>
        ) : (
          <li>
