...
const CATEGORY_MAPPING = {
    living: ["Pooja Unit", "Teapoy", "Storage Unit", "Swing", "Bed Side Table", "TV Unit"],
    dining: ["Dining Table Sets", "Dining Chairs", "Crockery Units", "Bar Cabinets"],
    bedroom: ["King Size Beds", "Queen Size Beds", "Wardrobes", "Dressing Tables"],
    office: ["Office Tables", "Office Chairs", "Bookshelfs"]
};
                ...
                <Form layout="vertical" onFinish={handleSubmit(onSubmit)} className="premium-form">
                    <div className="form-grid">
                        ...
                        <Form.Item label="Dimensions *" validateStatus={errors.dimensions ? "error" : ""} help={errors.dimensions?.message} className="full-width">
                            <Controller name="dimensions" control={control} render={({ field }) => <Input {...field} size="large" placeholder="E.g. 80 x 35 x 30 inches" />} />
                        </Form.Item>

                        <Form.Item label="Storage (Optional)" validateStatus={errors.storage ? "error" : ""} help={errors.storage?.message} className="full-width">
                            ...
                            <div className="upload-grid">
                                <Form.Item label="Main Feature Image" className="main-uploader">
                                    <Controller name="mainImage" control={control} render={({ field }) => (
                                        ...
                                        >
                                            {field.value?.fileList?.length >= 1 ? null : (
