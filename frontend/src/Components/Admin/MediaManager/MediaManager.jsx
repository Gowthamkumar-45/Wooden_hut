...
import { Table, Button, Modal, Form, Input, Space, message, Tag, Tabs } from 'antd';
import { VideoCameraOutlined, PlusOutlined, EditOutlined, DeleteOutlined, PictureOutlined, PlaySquareOutlined } from '@ant-design/icons';
